      ...
      <div className="content show_me_the_balls">
        ...
        <div className="stagger_container">
          <h4 className="expansive_bois">
            Fullstack Web3 developer at{" "}
            <a
              href="https://inevitable.media/"
              target="_blank"
          ...
          <h4 className="expansive_bois">
            Angular, React, Node, Solidity, Web3, Python, Unity, Arduino.
            <br />I can solve problems very well and learn things very quickly.
          </h4>
          <h4 className="expansive_bois">
            Think I could help with some unorthodox, artistic or weird project
            you are working on ?
            <br />
            <a
              href="mailto:kaynarodrigues@live.com"
              target="_blank"
              rel="noopener noreferrer"
            >
              Let me know
        ...
        <div className="exps_title expansive_bois">Personal projects</div>
