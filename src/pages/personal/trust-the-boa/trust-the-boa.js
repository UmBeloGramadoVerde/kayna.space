    ...
    return (
      <div className="content">
        ...
        <h4 className="expansive_bois">
          This is a collaborative wallet brands. We find cool stories, get cool artists that we would like to illustrate the wallets in however way they want and print the illustrations in fabric, from which we make the wallets.
        </h4>
        <h4 className="expansive_bois">
          It is legitimately fun to work on this with everybody and we also give 1 euro out of every wallet sold to an animal shelter in Covilhã, Portugal. We have one collection out and the prints of the second one are drawn and approved.
        </h4>
        <h4 className="expansive_bois">
